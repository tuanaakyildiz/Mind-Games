...
export default function DifficultyScreen() {
  ...
  useEffect(() => {
    if (isFocused) {
      checkDailyStatus('blockfill').then(setDailyCompleted);
    }
  }, [isFocused]);
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('BlockFillGame', { difficulty: 'medium', isDaily: true })}
      >
      ...
      {['easy', 'medium', 'hard'].map((level) => (
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('BlockFillGame', { difficulty: level, isDaily: false })}
        >
